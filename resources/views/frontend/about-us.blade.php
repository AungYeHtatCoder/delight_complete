 ...
 <div class="container">
  <div class="row align-items-center">
   <div class="col-lg-6 col-sm-12 col-md-8 mb-4 ">
    ...
    <p class="mb-4"><span style="font-weight: 700;">Delight Myanmar Company Team</span>က ဘယ်လိုမျိုးပုံစံနဲ့ service
     ပေးလည်း? </p>
    ...
    <ol class="about-list2 my-4" type="1">
     <li class="mb-2">Service ပေးရန် Team group ဖွဲ့ခြင်း၊
      ...
      Assistant Manager /AE / Content writter / Graphic Designer / Motion Designer / Artist / Customer service တို့နှင့်
      Team လေးတစ်ခု Messenger or viber မှာ Gp လေးလုပ်ဆောင်လိုက်ပါတယ်.</li>
     ...
     <li class="mb-2">
      ...
      ၃ရက်ကြာတဲ့အခါမှာတော့ လူကြီးမင်းတို့အား Delight team ဘက်မှ service ပေးရန် Content calender acc နှင့်အတူ meeting
      လုပ်ပေးပြီး အကြောင်းအရာများအား ညှိနှိုင်းဆွေးနွေးပေးပါမည်.
     </li>
     ...
     <li class="mb-2">
      Brand တစ်ခုအတွက်မရှိမဖြစ်လိုအပ်တဲ့ website အလန်းစားများ အား တစ်နေရာထဲမှာ one stop / non stop service ပေးနေတဲ့
      company တစ်ခုပဲဖြစ်ပါတယ်
     </li>
    </ol>
