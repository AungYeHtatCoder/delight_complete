...
<section id="services" class="services section-bg">
 <div class="container" data-aos="fade-up">
  ...
  <div class="section-title">
   <h2>Services</h2>
   <p>လူကြီးမင်းတို စီးပွားရေးလုပ်ငန်းများ တိုးတက်အောင်မြင်ရန်အတွက် plan များထဲတွင်ပါဝင်တဲ့ service နမူနာလေးများ
    လေ့လာလိုရပါသည်.</p>
  </div>
  ...
  <div class="row">
   <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
    <div class="icon-box">
     ...
     <p>လူကြီးမင်းတို့ စီးပွားရေးလုပ်ငန်းအကြောင်း စိတ်ဝင်စားမှုအမြင့်ဆုံးလုပ်ဆောင်ပေးမည့် Video လေးများ</p>
    </div>
   </div>
   ...
   <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
    <div class="icon-box">
     ...
     <p>လူကြီးမင်းတို့ Page အား Reach ရောက်အားမြှင့်တင်ပေးသွားမည့်ဟာသ comic art လေးများဖြစ်ပါတယ်</p>
    </div>
   </div>
   ...
   <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
    <div class="icon-box">
     ...
     <p>မြင်လိုက်တာနဲ့ ကျော်မသွားနိုင်အောင် စွဲဆောင်ပေးပြီး လူကြီးမင်းတို့ Product ကို ဖော်ပြပေးနိုင်မည့်
      ပုံအလန်းစားလေးများ</p>
    </div>
   </div>
   ...
   <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
    <div class="icon-box">
     ...
     <p>ထိမိဂွီ ဖြစ်စေမည့် Content အမိုက်စား ထိထိမိမိလေးများ</p>
    </div>
   </div>
