 ...
 <div class="content-header-light col-12">
  <div class="row">
   <div class="content-header-left col-md-9 col-12 mb-2">
    <h3 class="content-header-title">Service Sample Edit</h3>
    <div class="row breadcrumbs-top">
     <div class="breadcrumb-wrapper col-12">
      <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active">Service Sample Edit
       </li>
      </ol>
     </div>
    </div>
     ...
     <div class="card-body card-dashboard">
      <div class="row justify-content-md-center">
       <div class="col-md-6">
        <div class="card">
         <div class="card-header">
          <h4 class="card-title" id="from-actions-top-bottom-center">Service Sample Edit</h4>
          <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
          <div class="heading-elements">
           <ul class="list-inline mb-0">
            <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
         ...
         <div class="card-content collpase show">
          <div class="card-body">
           ...
           <form class="form" id="plan-form" method="post" action="{{ url('/samples/edit/'.$sample->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="form-body">
             <div class="row">
              <div class="form-group col-12 mb-2">
               <label for="name">Sample Name</label>
               <input type="text" id="name" class="form-control" placeholder="Sample Name" name="name" value="{{ $sample->name }}">
              </div>
              <div class="form-group col-12 mb-2">
                ...
                <select name="service_id" id="" class="form-control">
                    ...
                    <option value="{{ $service->id }}" {{ $service->id === $sample->service_id ? "selected" : "" }}>{{ $service->service_name }}</option>
                    @endforeach
                </select>
               </div>
               <div class="form-group col-12 mb-2">
