 ...
 <div class="content-header-light col-12">
  <div class="row">
   <div class="content-header-left col-md-9 col-12 mb-2">
    <h3 class="content-header-title">Plan Datatable</h3>
    <div class="row breadcrumbs-top">
     <div class="breadcrumb-wrapper col-12">
      <ol class="breadcrumb">
       <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a>
       </li>
       <li class="breadcrumb-item"><a href="{{ route('admin.plans.create') }}">Create Plan</a>
       </li>
       <li class="breadcrumb-item active">Plan Responsive Datatable
       </li>
      </ol>
     </div>
    </div>
  ...
  <div class="col-12">
   <div class="card">
    <div class="card-header">
     <h4 class="card-title">
      <a href="{{ route('admin.plans.create') }}" class="btn btn-success btn-round">New Plan Create</a>
     </h4>
       ...
       <tbody>
        ...
        <tr>
         ...
         <td>
          ...
          <a href="{{ route('admin.plans.show', $plan->id) }}" class="btn btn-primary btn-sm">Show</a>
          <form class="d-inline" action="{{ route('admin.plans.destroy', $plan->id) }}" method="POST">
           @csrf
           @method('DELETE')
