        ...
        <div class="card">
         ...
         <div class="card-content collpase show">
          <div class="card-body">
           ...
           <form class="form" method="post" action="{{ route('admin.our_teams.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="form-body">
             <div class="row">
              <div class="form-group col-12 mb-2">
               <label for="eventInput2">Team's Member Name</label>
             ...
             <div class="row">
              <div class="form-group col-12 mb-2">
               ...
               <input type="text" id="eventInput2" class="form-control" placeholder="Position" name="position">
              </div>
             </div>
             <div class="row">
              <div class="form-group col-12 mb-2">
               <label for="eventInput2">Bio</label>
               <input type="text" id="eventInput2" class="form-control" placeholder="Bio" name=" bio">
              </div>
             </div>
             <div class="row">
              <div class="form-group col-12 mb-2">
               <label for="sample">Choose Image</label>
               <input type="file" placeholder="" name="profile_img" class="form-control">
              </div>
             </div>
            </div>
