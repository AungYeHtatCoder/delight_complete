  ...
  <div class="col-12">
   <div class="card">
    <div class="card-header">
     <h4 class="card-title">
      <a href="{{ route('admin.our_clients.create') }}" class="btn btn-success btn-round">New Client Create</a>
     </h4>
      ...
      <table class="table table-striped table-bordered dataex-res-configuration">
       ...
       <tbody>
        ...
        <tr>
         ...
         <td>
          <a href="{{ route('admin.our_clients.edit', $client->id) }}" class="btn btn-warning btn-sm">Edit</a>
          <a href="{{ route('admin.our_clients.show', $client->id) }}" class="btn btn-primary btn-sm">Show</a>
          <form class="d-inline" action="{{ route('admin.our_clients.destroy', $client->id) }}" method="POST">
           @csrf
           @method('DELETE')
