        ...
        <div class="card">
         ...
         <div class="card-content collpase show">
          <div class="card-body">
           ...
           <form class="form" method="post" action="{{ route('admin.our_clients.store') }}"
            ...
            <div class="form-body">
             <div class="row">
              <div class="form-group col-12 mb-2">
               ...
               <input type="text" id="eventInput2" class="form-control" placeholder="User Name" name="client_name">
              </div>
             </div>
             <div class="row">
              <div class="form-group col-12 mb-2">
