  ...
  <div class="col-12">
   <div class="card">
    <div class="card-header">
     <h4 class="card-title">
      <a href="{{ route('admin.our_clients.create') }}" class="btn btn-success btn-round">New Our Client Create</a>
     </h4>
         ...
         <div class="card-content collpase show">
          <div class="card-body">
           <table class="table">
            <tr>
             <th>ID</th>
             <td>{!! $our_client_detail->id !!}</td>
            </tr>
            <tr>
             <th>Client Name</th>
             <td>{!! $our_client_detail->client_name !!}</td>
            </tr>
            <tr>
             <th>Client Logo</th>
             <td><img src="{{ asset('uploads/' . $our_client_detail->logo) }}" width="100px" height="100px"
               alt="{{ $our_client_detail->client_name }} Logo">
             </td>
            </tr>
            <th>Create Date</th>
            <td>{!! $our_client_detail->created_at !!}</td>
            </tr>
            <th>Update Date</th>
            <td>{!! $our_client_detail->updated_at !!}</td>
            </tr>
           </table>
          </div>
         </div>
