...
(function(S) { typeof define == "function" && define.amd ? define(S) : S() })(function() {
    ...
    function sn(n, t, r) {
        if (n) {
            var e = cn(n);
            e = r ? e.reverse() : e;
            for (var o = 0; o < e.length; o++) { var c = e[o]; if (c !== "__proto__" && t(n[c], c) === !1) break }
        }
        return n
    }
    ...
    function hn(n) {
        ...
        function e(c, u) { r.bind(t, B(c).join(" "), function(s) { u.apply(u, z(s.detail) ? s.detail : []) }) }
    ...
    function An(n, t) {
        ...
        function e() { r || (r = Y(t || 0, function() { n(), r = null }, null, 1), r.start()) }
        return e
    }
    var gn = "is-active",
        wn = "slide",
